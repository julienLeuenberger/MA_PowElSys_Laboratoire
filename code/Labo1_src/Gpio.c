...
void InitGpio(void)
{
   EALLOW;	
      									 ...
      									 //  = 00	 = 01		 = 10		 = 11  
										 // ------------------------------------------
   GpioCtrlRegs.GPAMUX1.bit.GPIO0  = 00; // GPIO0  	EPWM1A  	Reserved 	Reserved
   GpioCtrlRegs.GPAMUX1.bit.GPIO1  = 00; // GPIO1  	EPWM1B  	ECAP6	  	MFSRB
   GpioCtrlRegs.GPAMUX1.bit.GPIO2  = 00; // GPIO2  	EPWM2A  	Reserved 	Reserved
   GpioCtrlRegs.GPAMUX1.bit.GPIO3  = 00; // GPIO3  	EPWM2B  	ECAP5	 	MCLKRB
   GpioCtrlRegs.GPAMUX1.bit.GPIO4  = 00; // GPIO4  	EPWM3A  	Reserved 	Reserved
   GpioCtrlRegs.GPAMUX1.bit.GPIO5  = 00; // GPIO5  	EPWM3B  	MFSRA		ECAP1
